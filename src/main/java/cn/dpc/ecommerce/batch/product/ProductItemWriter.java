...
public class ProductItemWriter extends AbstractOpenSearcherItemWriter<Product> {
    ...
    public void write(Chunk<? extends Product> chunk) throws Exception {
        ...
        for (Product product : chunk) {
            ...
            productMap.put("product_deleted_at", product.getProduct_deleted_at());
            ...
            productMap.put("product_sale_stop_at", product.getProduct_sale_stop_at());
            ...
            productMap.put("product_sale_start_at", product.getProduct_sale_start_at());
